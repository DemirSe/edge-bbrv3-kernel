...
for sym in WIRELESS WLAN CFG80211 MAC80211 BT SOUND SND DRM DRM_BOCHS USB USB_SUPPORT FLOPPY ATA ATA_PIIX ATA_GENERIC CDROM BLK_DEV_SR ISO9660_FS UDF_FS VMWARE_VMCI VSOCKETS VIRTIO_VSOCKETS TUN IPV6_SIT IPV6_GRE IPV6_TUNNEL IPV6_VTI NETFILTER_XTABLES IP_TABLES DEBUG_INFO DEBUG_KERNEL GDB_SCRIPTS KGDB; do
...
for bad in WIRELESS WLAN BT SOUND SND DRM USB FLOPPY ATA CDROM BLK_DEV_SR ISO9660_FS UDF_FS VMWARE_VMCI VSOCKETS TUN IPV6_SIT IPV6_GRE IPV6_TUNNEL NETFILTER_XTABLES IP_TABLES DEBUG_INFO; do
